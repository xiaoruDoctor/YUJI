...
- [小羽](./visual-system/xiaoyu/README.md)：YUJI 的固定女生球友，用于小红书、视频、羽迹卡样稿和品牌物料中需要人物承载情绪的画面。她不是内部 Agent，也不是虚拟偶像；她是品牌前台的球友视角。
...
- 本地是实时工作区，GitHub 是每日远端镜像。
- 同一时间同步到 GitHub 仓库：`https://github.com/xiaoruDoctor/YUJI`
- 每天 20:00（Asia/Shanghai）增量同步当天变动到 GitHub。
